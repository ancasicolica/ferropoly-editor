...
module.exports = function (settings) {
  ...
  settings.oAuth.microsoft.appId       = process.env.FERROPOLY_MICROSOFT_APP_ID_EP || 'nodos';
  settings.oAuth.microsoft.secret      = process.env.FERROPOLY_MICROSOFT_APP_SECRET_EP || 'no_secret';
